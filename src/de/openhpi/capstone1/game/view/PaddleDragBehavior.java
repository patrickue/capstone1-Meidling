...
public class PaddleDragBehavior extends UpdateBehavior {
	...
	public void update() {
		...
		} else if (paddle.getXpos() >= display.width - paddle.getPaddleWidth()) { // if the mouse goes beyond the right side of the canvas/
			paddle.setXpos(display.width - paddle.getPaddleWidth()); // then set the paddle to the right-most edge of the canvas
		}
